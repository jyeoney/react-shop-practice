...
const FacebookImg = () => {
  return (
    <a rel="noreferrer noopener external" href="/" target="_blank" data-tip="facebook" className="tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
        <path id="path4" d="m17 2v4h-2c-0.69 0-1 0.81-1 1.5v2.5h3v4h-3v8h-4v-8h-3v-4h3v-4a4 4 0 0 1 4 -4h3z"></path>
      </svg>
    </a>
  );
};
...
const InstagramImg = () => {
  return (
    <a rel="noreferrer noopener external" href="/" target="_blank" data-tip="Instagram" className="tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" className="fill-current">
